...
PtestGk2::PtestGk2(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::PtestGk2),m_coun(602),w_ans(0),r_ans(0),r_msg("Total Correct Answers - कुल सही उत्तर: %1"),w_msg("Total number of questions attempted - प्रयास किये गए कुल प्रश्नों की संख्या: %1")
{
    ui->setupUi(this);
}
...
void PtestGk2::on_pushButton_clicked()
{
...
void PtestGk2::on_radioButton_clicked()
{
    QString s,y;
    s = ui->no->text();
    y = ui->yes->text();
...
void PtestGk2::on_radioButton_2_clicked()
{
    QString s,y;
    s = ui->no->text();
    y = ui->yes->text();
...
void PtestGk2::on_radioButton_3_clicked()
{
    QString s,y;
    s = ui->no->text();
    y = ui->yes->text();
...
void PtestGk2::on_radioButton_4_clicked()
{
    QString s,y;
    s = ui->no->text();
    y = ui->yes->text();
